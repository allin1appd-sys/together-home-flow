...
export default function JoinHousehold() {
  ...
  // If already logged in, just show join confirmation
    ...
    <div className="flex items-center justify-center min-h-screen bg-background px-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Join HomeHub</CardTitle>
          <CardDescription>
            You've been invited to join a household. Enter your name to get started!
          </CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {code && (
              <div className="p-3 rounded-xl bg-muted/50 text-center">
                <p className="text-[11px] text-muted-foreground mb-1">Invite code</p>
