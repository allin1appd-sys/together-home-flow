...
const SwipeableReminderCard = ({ reminder, onTap, onDelete, onToggle, onSnooze }: SwipeableReminderCardProps) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl">
      ...
      >
        <Card
          className={`overflow-hidden cursor-pointer active:scale-[0.98] transition-transform ${reminder.isChecked ? 'opacity-50' : ''}`}
          onClick={onTap}
        >
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <h3 className={`font-semibold text-sm ${reminder.isChecked ? 'line-through text-muted-foreground' : ''}`}>
                  {reminder.title}
                </h3>
                ...
                <div className="flex items-center gap-1.5 text-xs text-muted-foreground mt-1.5">
                  ...
                  {!isOverdue && !isDueToday && !reminder.isChecked && (
