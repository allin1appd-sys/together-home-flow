...
const Trips = () => {
  ...
  const handleSave = () => {
    const parsed = tripSchema.safeParse({
      title: form.title, destination: form.destination, startDate: form.startDate,
      endDate: form.endDate, description: form.description || undefined,
  ...
  return (
    <PullToRefresh queryKeys={[['trips', householdId!]]}>
      <div className="px-4 pt-6 pb-24 space-y-4">
        ...
        {trips.length === 0 ? (
          <EmptyState icon={Plane} title="No trips planned" description="Start planning your next adventure" actionLabel="Add trip" onAction={openAdd} />
        ) : (
